...
CREATE TABLE `EvaluationAssignment` (
    ...
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `evalStatus` ENUM('NOT_STARTED', 'IN_PROGRESS', 'SUBMITTED') NOT NULL DEFAULT 'NOT_STARTED',
    ...
    INDEX `EvaluationAssignment_submittedById_fkey`(`submittedById` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `KpiPlan` (
    ...
    `confirmRequestedById` VARCHAR(191) NULL,
    `confirmStatus` ENUM('DRAFT', 'REQUESTED', 'CONFIRMED', 'REJECTED', 'CANCELLED') NOT NULL DEFAULT 'DRAFT',
    `confirmTarget` ENUM('EVALUATOR', 'EVALUATEE') NULL,
    ...
    INDEX `KpiPlan_assignmentId_confirmStatus_idx`(`assignmentId` ASC, `confirmStatus` ASC),
    ...
    INDEX `KpiPlan_confirmRequestedById_fkey`(`confirmRequestedById` ASC),
    INDEX `KpiPlan_confirmStatus_confirmTarget_idx`(`confirmStatus` ASC, `confirmTarget` ASC),
    INDEX `KpiPlan_confirmedById_fkey`(`confirmedById` ASC),
    INDEX `KpiPlan_rejectedById_fkey`(`rejectedById` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
